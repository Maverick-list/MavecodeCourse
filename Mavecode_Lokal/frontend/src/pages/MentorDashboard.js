...
import { 
    X, Code2, MessageSquareText, Sparkles, Send, 
...
const MentorDashboard = () => {
    ...
    return (
        <div className="min-h-screen pt-20 bg-slate-950 text-slate-200 font-sans selection:bg-primary/30">
            ...
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-[calc(100vh-100px)] flex flex-col gap-4 pb-4">
                
                {/* Header Stats / Status Bar */}
                <div className="flex flex-wrap items-center justify-between bg-slate-900/50 border border-white/5 backdrop-blur-xl rounded-2xl px-6 py-3">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="hidden md:flex items-center gap-6 border-l border-white/10 pl-6 h-10">
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs font-mono text-primary">{pageContext.language}</span>
                            </div>
                            <div className="flex flex-col">
                ...
                <div className="flex-1 flex flex-col lg:flex-row gap-4 overflow-hidden">
                    ...
                    <div className="flex-[1.2] flex flex-col bg-slate-900/30 rounded-3xl border border-white/5 overflow-hidden group shadow-2xl">
                        {/* Editor Controls */}
                    ...
                    <div className="flex-1 flex flex-col bg-slate-900/50 rounded-3xl border border-white/10 overflow-hidden shadow-2xl relative">
                        
                        {/* Action Buttons Toolbar */}
                        <div className="grid grid-cols-4 border-b border-white/5 bg-slate-900/80">
                            {[
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className={`flex flex-col items-center justify-center gap-2 py-4 border-r last:border-r-0 border-white/5 hover:bg-white/5 transition-all relative group disabled:opacity-50 ${activeAnalysisMode === btn.id ? 'bg-primary/10' : ''}`}
                                >
                                    ...
                                    {activeAnalysisMode === btn.id && (
                                        <motion.div layoutId="mode-border" className="absolute bottom-0 left-0 right-0 h-0.5 bg-primary shadow-glow shadow-primary/50" />
                                    )}
                                </button>
                            ))}
                        </div>
                                ...
                                {messages.map((msg, i) => (
                                    ...
                                    >
                                        <div className={`group relative max-w-[90%] rounded-2xl px-5 py-4 shadow-xl overflow-hidden ${
                                            ...
                                            : 'bg-slate-800/40 border border-white/5 backdrop-blur-md'
                                        }`}>
